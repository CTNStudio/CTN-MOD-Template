...
public class ArmorMaterials {
    public static final DeferredRegister<ArmorMaterial> ARMOR_MATERIALS_TYPE_REGISTER = DeferredRegister.create(BuiltInRegistries.ARMOR_MATERIAL, CtnTemplate.ID);
